      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-[#0a1f44]">Why Choose B2 Tech Services</h2>
            <p className="text-[#00809D] leading-relaxed mx-auto max-w-2xl">
              Connecting talent with opportunities, empowering organizations to thrive in the digital age.
            </p>
          </div>
          ...
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="text-gray-500">Believe & Become</p>
          </div>
        </div>
      </section>
    </div>
